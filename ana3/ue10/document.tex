...
\begin{align*}
	...
	-2r\sin^3(t)\\ -2r\cos^3(t)\\ 4r
\end{pmatrix}
\end{align*}

Tangentialvektor
\begin{align*}
	\bm{t} = \left(\frac{\partial}{\partial t} 2\cos(t), \frac{\partial}{\partial t} 2\sin(t), \frac{\partial}{\partial t} \cos(t)\sin(t)\right)^\top = (-2\sin(t), 2\cos(t), \cos^2(t)-\sin^2(t))^\top
\end{align*}
